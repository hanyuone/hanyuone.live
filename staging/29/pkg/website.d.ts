...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__hebd08bd7ab7e2ec0: (a: number, b: number, c: any, d: any) => void;
  readonly wasm_bindgen__closure__destroy__h21f9ea25eef987d0: (a: number, b: number) => void;
